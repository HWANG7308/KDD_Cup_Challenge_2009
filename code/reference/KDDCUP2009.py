...
# train_path = path + './data/orange_small_train.data'
# churn_path = path + './label/orange_small_train_churn.labels.txt'
# test_path = path + './data/orange_small_test.data'
train_path = '../../data/feature/orange_small_train.data'
churn_path = '../../data/label/orange_small_train_churn.labels.txt'
appetency_path = '../../data/label/orange_small_train_appetency.labels.txt'
test_path = '../../data/feature/orange_small_test.data'

X = pd.read_table(train_path)

# Y = pd.read_table(churn_path, header=None).ix[:, 0].astype('category')
Y = pd.read_table(appetency_path, header=None).ix[:, 0].astype('category')
...
def drawModelComparison(results):
    ...
    plt.title("Model Comparison for churn labels")
    ...
    plt.savefig('Model_Comparison churn.png')
